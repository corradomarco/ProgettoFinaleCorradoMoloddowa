...
export class LoginComponent {
  ...
  getUnitList(): void {
    ...
    this.obsUnit = this.http.get<Utente[]>('https://3000-c65c077b-f8d3-4284-8483-7fb41f036028.ws-eu01.gitpod.io/users');
...
addUnit(Username: HTMLInputElement,Password:HTMLInputElement): void {
    ...
    console.log("fffff");
    this.postObserver = this.http.get(`https://3000-c65c077b-f8d3-4284-8483-7fb41f036028.ws-eu01.gitpod.io/search/${Username.value}/${Password.value}`); //Cambiato url e tipo di oggetto restituito dal server
