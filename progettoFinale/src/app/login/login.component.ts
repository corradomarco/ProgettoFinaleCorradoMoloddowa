...
export class LoginComponent {
  ...
  getUnitList(): void {
    ...
    this.obsUnit = this.http.get<Utente[]>('https://3000-af4aa3f2-1218-4da1-8041-dd02442aa1f1.ws-eu01.gitpod.io/users');
...
addUnit(Username: HTMLInputElement,Password:HTMLInputElement): void {
    ...
    console.log("fffff");
    this.postObserver = this.http.get(`https://3000-af4aa3f2-1218-4da1-8041-dd02442aa1f1.ws-eu01.gitpod.io/search/${Username.value}/${Password.value}`); //Cambiato url e tipo di oggetto restituito dal server
